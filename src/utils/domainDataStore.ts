...
import { CreatePerson, CreateProperty, Person, Property, UpdateProperty } from "./domainSchemas";
...
interface PersonStore {
    persons: Person[],
    createPerson: (newPersonData: CreatePerson) => Promise<StoreResponse<Person['id']>>
}
