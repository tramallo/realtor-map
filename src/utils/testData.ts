 ...
 */
import { PersonSchema, PropertySchema, RealtorSchema } from "./domainSchemas";

export const testPersons: PersonSchema[] = [
...
export const testRealtors: RealtorSchema[] = [
...
export const testProperties: PropertySchema[] = [
